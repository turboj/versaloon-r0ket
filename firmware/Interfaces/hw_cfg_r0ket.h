...
// TRST, P3.1 == SS4
#define SW_RST_PORT						3
#define SW_RST_PIN						1
//SYNCSW == TMS, SS1 P2.5
#define SYNCSW_IN_PORT					2
#define SYNCSW_IN_PIN					5
#define SYNCSW_OUT_PORT					2
#define SYNCSW_OUT_PIN					5
...
// TDI 0.9 TDO 0.8
#define JTAG_SPI_PORT					0
#define JTAG_TAP_TDO_PIN				8
#define JTAG_TAP_TDI_PIN				9

#define JTAG_TAP_PORT					2
// TCK 2.4
#define JTAG_TAP_TCK_PIN				4

#define JTAG_TAP_RTCK_PORT				2
#define JTAG_TAP_RTCK_PIN				10

#define JTAG_HAS_USER_PIN				0

#define JTAG_TAP_USR_PORT				3
...
#define JTAG_TAP_TDI_SETOUTPUT()		GPIO_SetMode(JTAG_SPI_PORT, JTAG_TAP_TDI_PIN, GPIO_MODE_OUT_PP)
#define JTAG_TAP_TDI_SETINPUT()			GPIO_SetMode(JTAG_SPI_PORT, JTAG_TAP_TDI_PIN, GPIO_MODE_IN_FLOATING)
#define JTAG_TAP_TDI_SET()				GPIO_SetPins(JTAG_SPI_PORT, JTAG_TAP_TDI_PIN)
#define JTAG_TAP_TDI_CLR()				GPIO_ClrPins(JTAG_SPI_PORT, JTAG_TAP_TDI_PIN)
#define JTAG_TAP_TDI_GET()				GPIO_GetOutPins(JTAG_SPI_PORT, JTAG_TAP_TDI_PIN)

#define JTAG_TAP_TDO_SETINPUT()			GPIO_SetMode(JTAG_SPI_PORT, JTAG_TAP_TDO_PIN, GPIO_MODE_IN_FLOATING)
#define JTAG_TAP_TDO_SET()				GPIO_SetPins(JTAG_SPI_PORT, JTAG_TAP_TDO_PIN)
#define JTAG_TAP_TDO_CLR()				GPIO_ClrPins(JTAG_SPI_PORT, JTAG_TAP_TDO_PIN)
#define JTAG_TAP_TDO_GET()				GPIO_GetInPins(JTAG_SPI_PORT, JTAG_TAP_TDO_PIN)
...
#define JTAG_TAP_HS_DMA_FINI()			do{	} while (0)
#define JTAG_TAP_HS_DMA_INIT()			do{   } while (0)
...
#define LED_USB_INIT()					
#define LED_USB_ON() 	gpioSetValue(1,7,1)
#define LED_USB_OFF()	gpioSetValue(1,7,0)
